...
###
# TC: KIỂM TRA CHECKBOX "GAME NOTIFICATIONS" Ở GIAO DIỆN SETTING:
...
# Steps 5:
# Click vào checkbox "Game notifications".
...
# Khi checkbox được chọn, các thông báo của game sẽ được hiển thị trên thanh thông báo của thiết bị và ngược lại.
