...
###
# TC: KIỂM TRA CHECKBOX "WELCOM SCREEN" Ở GIAO DIỆN SETTING:
...
# Steps 5:
# Click vào checkbox "WELCOM SCREEN".
...
# Khi checkbox được chọn sẽ hiển thị màn hình Welcome khi vào game và ngược lại.