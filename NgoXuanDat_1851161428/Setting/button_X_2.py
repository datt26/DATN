...
###
# TC: KIỂM TRA THOÁT GIAO DIỆN SETTING TẠI MÀN HÌNH MULTIPLAYER:
...
# Steps 5:
# Click vào button "SETT" ở chế độ Multiplay.
...
# Expect Result:
# Đóng màn hình Setting và quay lại giao diện chế độ chơi Multiplayer.