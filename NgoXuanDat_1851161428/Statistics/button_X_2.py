...
###
# TC: KIỂM TRA THOÁT GIAO DIỆN STATISTICS TẠI MÀN HÌNH MULTIPLAYER:
...
# Steps 5:
# Click vào button "STATS" ở chế độ Multiplay.
...
# Expect Result:
# Đóng màn hình Statistics và quay lại giao diện chế độ chơi Multiplayer.